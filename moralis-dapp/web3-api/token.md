...
using MoralisWeb3ApiSdk;
  ...
  {
    string status = await  MoralisInterface.GetClient().Web3Api.Token.ReSyncMetadata({address :"0x7de3085b3190b3a787822ee16f23be010f5f8686",token_id: tokenId, chain : ChainList.eth});
    print(status);
  }
```
