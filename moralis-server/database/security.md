...
```
var privateData = Moralis.Object.extend("PrivateUserData");
privateData.setACL(new Moralis.ACL(Moralis.User.current()));
privateData.set("phoneNumber", "555-5309");

Moralis.User.current().set("privateData", privateData);
```
